	...
	public void createFrame() {
   		...
   		btn2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Enroll enroll = new Enroll(animalnameA.getText(),animalgender_check,animalgenderA.getText(),
						 Integer.parseInt(animalageA.getText()),genderless_check,nameA.getText(),phoneA.getText(),0);
